...
function Routes() {
  ...
  // Экран загрузки — поверх вкладок, а не отдельным маршрутом. Пока он открыт, вкладки состояние
  // не получают: оно применяется один раз в конце. Под ним вкладки переключаются на центральную,
  // поэтому после любой загрузки открывается главный экран (см. (tabs)/_layout.tsx).
