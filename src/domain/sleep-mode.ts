 ...
 * («зона бодрствования»), поэтому раньше привычного больше чем на час не сдвигаем.
...
/**
 * Строка состояния на карточке. Днём строки нет: «План на вечер» звучал нелепо, когда человек
 * ложится в два часа ночи (решение владельца 26.09).
 */
export const SLEEP_MODE_PHASE_TEXT: Record<SleepModePhase, string | null> = {
  day: null,
