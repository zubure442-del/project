...
const DISCLAIMER =
  'Vuelo показывает то, что измерило кольцо. Это не медицинский прибор: приложение не ставит диагнозов, ' +
  'не даёт медицинских рекомендаций и не заменяет врача. Давление и глюкозу кольцо оценивает по пульсовой ' +
  'волне, а не измеряет. Данные хранятся только на вашем телефоне.';
