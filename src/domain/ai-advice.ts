...
/**
 * Чего в совете быть не должно (правила продукта): диагнозы, болезни, лечение и врачи, оценки
 * фигуры, обещания результата, чужие приложения и бренды, разметка. Давление, сахар и кислород
 * как процессы тела Лис называть может (владелец 26.09), без значений и диагнозов. Сравнение — по началу слова без учёта регистра.
 */
export const AI_ADVICE_FORBIDDEN = [
  ...
  'пройдёт', 'пройдет', 'гарантир', 'ожирен', 'имт', 'полнот',
