...
import { LOAD_BOX_H_FLOOR, LOAD_BOX_MIN_WIDTH, chartAxis, loadBoxes, pulseAt, deepShareLabel, formatMinute, hypnogramSegments, niceTicks, sleepStage, stepsByHour, stressZone } from './charts';
...
describe('ось статичных графиков «Организма»', () => {
