...
export interface StoredReport {
  ...
  text: string;
  /**
   * О чём было мнение Лиса от модели: ключ связки движка физиологии («idle-deep-debt»). По нему
   * движок выбирает в следующий раз другую связку. `action` — от старых версий. У шаблонов полей нет.
   */
  focus?: string[];
  action?: string | null;
