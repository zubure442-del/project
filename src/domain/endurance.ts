...
export const ENDURANCE_INFO = {
  title: 'Пик выносливости',
  text:
    'Пик выносливости — время, в которое вашему организму наиболее эффективно получать нагрузку. ' +
    'Мы подбираем его каждый день по вашим данным и подсказываем, какую тренировку выбрать ' +
    'и насколько интенсивно заниматься.\n\n' +
    NOT_MEDICAL_DEVICE,
} as const;
