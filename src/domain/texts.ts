...
/**
 * Пояснение на «Сегодня» для прошлой даты: итога и оценок там нет, потому что они считаются
 * по циклам сна и бодрствования, а не по календарным суткам.
 */
export const PAST_DAY_NOTE =
  'Индекс дня и основные метрики считаются динамически — по вашим циклам сна и бодрствования. ' +
  'Поэтому за прошлые дни показываем только измеренные данные.';
