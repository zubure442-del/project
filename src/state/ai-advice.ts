 ...
 * (тренировка, кофе, еда, время отхода ко сну). Готовых выводов приложение не шлёт: главное
 * наблюдение дня по этим числам выбирает посредник (`server/advice`), модель его только говорит.
